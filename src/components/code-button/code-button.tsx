...
export const CodeButton: FC<Props> = ({ expandFunc }) => {
  return (
    <button
      onClick={expandFunc}
      className="my-2 border border-[#f78b07] bg-slate-900 text-white
    ...
    >
      <div
        className="bg-[#f78b07] flex items-center 
        justify-center rounded-lg w-14 bg-bg-200  border-r-[0.5px] border-r-[#f78b07]"
      >
        <svg
